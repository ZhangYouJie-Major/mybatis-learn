...
public final class TypeHandlerRegistry {
  ...
  /**
   * 根据JdbcType对应的TypeHandler(优先级比较低)
   */
  private final Map<JdbcType, TypeHandler<?>> JDBC_TYPE_HANDLER_MAP = new EnumMap<JdbcType, TypeHandler<?>>(JdbcType.class);

  /**
   * 参数类型对应的TypeHandler(优先级比较高)
   */
  ...
  /**
   * 保存所有的TypeHandler， Key是TypeHandler的Class，Value是TypeHandle对象
   */
  ...
  public TypeHandlerRegistry() {
    ...
    /**
     * 1、指定javaType 没有指定jdbcType 默认使用 DateTypeHandler
     * 2、指定javaType 指定jdbcType 使用DateOnlyTypeHandler  TimeOnlyTypeHandler
     * 3、指定了jdbcType 使用DateTypeHandler DateOnlyTypeHandler  TimeOnlyTypeHandler
     * 4、指定了javaType sql的时间类型 SqlDateTypeHandler SqlTimeTypeHandler SqlTimestampTypeHandler
     */
